...
import { store } from '@/actions/App/Http/Controllers/Admin/Auth/RegisterController';
...
<template>
    ...
    >
        <div class="grid gap-6">
            ...
            <Button type="submit" class="mt-2 w-full" tabindex="5" :disabled="processing" data-test="admin-register-button">
