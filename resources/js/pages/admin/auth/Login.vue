...
import { store } from '@/actions/App/Http/Controllers/Admin/Auth/LoginController';
...
<template>
    ...
    >
        <div class="grid gap-6">
            ...
            <Button type="submit" class="mt-4 w-full" :tabindex="4" :disabled="processing" data-test="admin-login-button">
